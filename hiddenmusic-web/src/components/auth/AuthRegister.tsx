...
import { UserPlus, Key, Mail, Disc3, ArrowRight, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 font-mono select-none">
      <div className="w-full max-w-md p-6 sm:p-8 rounded-3xl bg-black/70 border border-white/15 backdrop-blur-2xl shadow-2xl space-y-6">
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <p className="text-xs text-slate-400">Tạo tài khoản để nghe nhạc chất lượng cao & bình luận</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-slate-400 uppercase">Tên hiển thị (Username)</label>
